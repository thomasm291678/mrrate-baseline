...
c.exec_command(f"nohup bash -c '{cmd_t1}' &", timeout=5)
print(f"T1 started: train_v4_t1_{TS}.log")

time.sleep(210)

s, o, e = c.exec_command(
    f"tail -12 /home/jiaqigu/mrrate_hidnet/outputs/report_gen/train_v4_t1_{TS}.log 2>/dev/null",
    timeout=10)
print("\n" + o.read().decode())
