...
cmd = (
    ...
    f"--batch_size 8 --ga_steps 1 --epochs 2 --num_workers 2 "
...
print(f"V5 encoder v3: train_v5_encoder_{ts}.log (fixed contrastive loss)")

time.sleep(210)

s, o, e = c.exec_command(
    f"tail -12 /home/jiaqigu/mrrate_hidnet/outputs/report_gen/train_v5_encoder_{ts}.log 2>/dev/null",
    timeout=10)
print("\n" + o.read().decode())
