...
script = "/home/jiaqigu/hidnet_env/bin/python"
proj = "/home/jiaqigu/mrrate_hidnet"
cmd = (
    f"cd {proj} && CUDA_VISIBLE_DEVICES=6 nohup {script} -u scripts/train.py "
...
print("Waiting 180s (compile + load)...")
time.sleep(180)
