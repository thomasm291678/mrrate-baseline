...
# Force-kill all processes on GPU2
c.exec_command("fuser -v /dev/nvidia2 2>&1", timeout=5)
...
print("GPU2 after cleanup:", o.read().decode().strip())
...
stdin, o, e = c.exec_command(f"tail -12 /home/jiaqigu/mrrate_hidnet/outputs/report_gen/train_v3_{ts}.log", timeout=10)
print(o.read().decode())
