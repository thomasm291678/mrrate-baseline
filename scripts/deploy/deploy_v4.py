...
sftp.put(r"C:\Users\HP\Documents\5555\uniformer_blocks.py", "/home/jiaqigu/mrrate_hidnet/uniformer_blocks.py")
sftp.put(r"C:\Users\HP\Documents\5555\eval_report.py", "/home/jiaqigu/mrrate_hidnet/eval_report.py")
print("Code uploaded")

# Upload BrainMVP weights
print("Uploading BrainMVP weights (1.13GB)...")
dst = "/home/jiaqigu/mrrate_hidnet/outputs/report_gen/BrainMVP_uniformer.pt"
sftp.put(r"C:\Users\HP\Downloads\BrainMVP_uniformer.pt", dst)
sftp.close()
print("Weights uploaded")

# Verify
s, o, e = c.exec_command(f"ls -lh {dst}", timeout=10)
print(o.read().decode().strip())

# Launch V4 training on GPU3
...
s, o, e = c.exec_command(
    f"tail -8 /home/jiaqigu/mrrate_hidnet/outputs/report_gen/train_v4_gpu3_{ts}.log 2>/dev/null",
    timeout=10)
print("\n" + o.read().decode())
